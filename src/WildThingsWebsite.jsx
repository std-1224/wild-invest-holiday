...
const WildThingsWebsite = () => {
  ...
  const [investmentAttitude, setInvestmentAttitude] = useState(
  ...
  const [selectedCabinForInvestment, setSelectedCabinForInvestment] =
    useState(null);
  const [showExistingOwnerModal, setShowExistingOwnerModal] = useState(false);
  const [showFloatingInvestmentPanel, setShowFloatingInvestmentPanel] =
    useState(false);
  ...
  const [contracts, setContracts] = useState([
    {
      ...
      contracts: [
        ...
        {
          type: "Land Lease Agreement",
          status: "Signed",
          signedDate: "2024-01-15",
        },
        {
          type: "Site Management Agreement",
          status: "Signed",
          signedDate: "2024-01-15",
        },
      ],
  ...
  const getExtrasForCabin = (cabinType) => {
    ...
    return [
      ...
      },
      {
        ...
        nightlyImpact: 15,
        impactDescription:
          "+$15/night - Luxury amenities attract premium guests",
        annualCostSavings: 0,
      },
      {
        id: "solar",
  ...
  const calculateDynamicNightlyRate = (selectedExtras, cabinType) => {
    ...
    const totalImpact = extras.reduce((total, extra) => {
      return (
        total + (selectedExtras.includes(extra.id) ? extra.nightlyImpact : 0)
      );
    }, 0);
  ...
  const calculateROI = (
    ...
    // Calculate dynamic nightly rate based on selected extras
    const dynamicNightlyRate = calculateDynamicNightlyRate(
      selectedExtras,
      cabinType
    );
    ...
    const managementFee = grossRevenue * 0.2;
    ...
    let annualCostSavings = extras.reduce((total, extra) => {
      return (
        total +
        (selectedExtras.includes(extra.id) ? extra.annualCostSavings : 0)
      );
    }, 0);
        ...
        >
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                <div style={{ color: colors.white, fontWeight: "bold" }}>
                  James
                </div>
                <div style={{ color: colors.aqua, fontSize: "12px" }}>
                  Wild Things Team
                </div>
              </div>
            </div>
  ...
  const NavBar = () => (
    <div
      ...
      style={{
        backgroundColor: "rgba(134, 219, 223, 0.9)",
        padding: "15px 0",
        borderBottom: "4px solid #FFCF00",
      }}
    >
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center">
          ...
          <div
            ...
            style={{ flexWrap: "wrap", alignItems: "center", gap: "20px" }}
          >
            <button
              onClick={() => setCurrentPage("home")}
              style={{
            ...
            <button
              ...
              style={{
                ...
                fontStyle: "italic",
                textDecoration:
                  currentPage === "holiday-homes" ? "underline" : "none",
                textDecorationColor: "#FFCF00",
                textDecorationThickness: "3px",
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                fontStyle: "italic",
                textDecoration:
                  currentPage === "locations" ? "underline" : "none",
                textDecorationColor: "#FFCF00",
                textDecorationThickness: "3px",
              }}
            >
            ...
            {isLoggedIn ? (
              <button
                ...
                style={{
                  ...
                  fontStyle: "italic",
                  textDecoration:
                    currentPage === "investor-portal" ? "underline" : "none",
                  textDecorationColor: "#FFCF00",
                  textDecorationThickness: "3px",
                  padding: "0",
                  margin: "0",
    ...
    <div className="pt-32 w-full max-w-full overflow-x-hidden">
      ...
      >
        ...
        >
          ...
          <div
            className="absolute inset-0"
            style={{ backgroundColor: "rgba(14, 24, 31, 0.3)" }}
          ></div>
        </div>
        <div
        ...
        >
          <h1
            className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6 italic leading-tight"
            style={{
              fontFamily:
                '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
              fontWeight: "900",
          ...
          <p
            className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 max-w-2xl font-medium px-2"
      ...
      <div
        className="py-16 px-4 w-full max-w-full overflow-x-hidden"
        style={{ backgroundColor: colors.lightGray }}
      >
        <div className="max-w-7xl mx-auto w-full">
          <h2
            className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 text-center italic px-2"
            style={{
              fontFamily:
                '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
              fontWeight: "900",
          ...
          <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-lg w-full max-w-full overflow-x-hidden">
            ...
            >
              Check out our latest adventures on TikTok!
            </p>
      ...
      {/* Our Mission Section */}
      <div
        className="py-12 sm:py-16 md:py-20 px-4 w-full max-w-full overflow-x-hidden"
        style={{ backgroundColor: colors.darkBlue }}
      >
        <div className="max-w-4xl mx-auto text-center w-full">
          <h2
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 italic px-2"
            style={{
              fontFamily:
                '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
              fontWeight: "900",
          ...
          <div
            ...
            style={{ color: colors.white, fontSize: "1rem", lineHeight: "1.8" }}
          >
            <p
            ...
            >
              ...
              disconnect from the world, from technology, and reconnect with
              family and nature.
            </p>
          </div>
        </div>
      ...
      <div
        className="py-12 sm:py-16 px-4 w-full max-w-full overflow-x-hidden"
        style={{ backgroundColor: colors.white }}
      >
        <div className="max-w-7xl mx-auto w-full">
          <h2
            className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-center italic px-2"
            style={{
              fontFamily:
                '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
              fontWeight: "900",
  ...
  const HolidayHomesPage = () => {
    ...
    const faqs = [
      ...
      {
        question:
          "Can I offset losses against my other income (negative gearing)?",
        answer:
      ...
      {
        question:
          "Can I claim travel expenses to inspect or maintain my cabin?",
        answer:
      ...
      {
        question:
          "What happens if the park relocates, upgrades or renews sites?",
        answer:
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    >
                      ...
                      <span style={{ color: colors.darkBlue }}>
                        ${roiResults.dynamicNightlyRate.toFixed(0)}/night
                      </span>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    >
                      ...
                      <span className="font-bold">
                        $
                        {roiResults.grossRevenue.toLocaleString("en-AU", {
                    ...
                    >
                      ...
                      <span className="font-bold">
                        -$
                        {roiResults.managementFee.toLocaleString("en-AU", {
                          maximumFractionDigits: 0,
                        })}
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <span className="font-bold">
                        -$
                        {roiResults.siteFeeAnnual.toLocaleString("en-AU", {
                          maximumFractionDigits: 0,
                        })}
                      </span>
                    </div>
                    ...
                    >
                      ...
                      <span className="font-bold">
                        -$
                        {roiResults.totalEnergyCosts.toLocaleString("en-AU", {
                          maximumFractionDigits: 0,
                        })}
                      </span>
                    </div>
                    {roiResults.annualCostSavings > 0 && (
                      ...
                      >
                        ...
                        <span className="font-bold">
                          +$
                          {roiResults.annualCostSavings.toLocaleString(
                            "en-AU",
                            { maximumFractionDigits: 0 }
                          )}
                        </span>
                    ...
                    >
                      ...
                      <span>
                        $
                        {roiResults.netIncome.toLocaleString("en-AU", {
                          maximumFractionDigits: 0,
                        })}
                      </span>
                    </div>
    ...
    const parkExperiences = [
      {
        ...
        image: "/water-ski.svg",
        description:
          "Experience the thrill of water skiing on our pristine lake",
      },
      {
        name: "Playground",
        icon: "🛝",
        ...
        description:
          "Family fun with our state-of-the-art playground equipment",
      },
      {
        name: "Pool",
        icon: "🏊",
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden mb-8">
            ...
            <div className="md:hidden">
              ...
              <div className="p-6">
                <h2
                  className="text-3xl font-bold mb-3 italic"
                  style={{
                    fontFamily:
                      '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
                    fontWeight: "900",
                ...
                <div className="mb-6">
                  <h3
                    className="text-lg font-bold mb-3 italic"
                    style={{
                      fontFamily:
                        '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
                      fontWeight: "900",
          ...
          <div className="bg-white rounded-lg shadow-xl overflow-hidden mb-8">
            ...
            >
              ...
              <div className="p-8 flex flex-col justify-center">
                ...
                <p className="text-gray-700 mb-6">
                  Australia's iconic coastal paradise. Beach vibes, rainforest
                  adventures, and unforgettable sunrises await at our newest
                  location.
                </p>
                <button
                  disabled
          ...
          <div className="bg-white rounded-lg shadow-xl p-8">
            <h2
              className="text-4xl font-bold mb-6 text-center italic"
              style={{
                fontFamily:
                  '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
                fontWeight: "900",
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex-1">
                      ...
                      >
                        ...
                        <strong>$1,000</strong> towards your next cabin
                        purchase!
                      </p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="space-y-1 text-sm">
                          ...
                          {floatingInvestmentData.selectedExtras?.length >
                            0 && (
                            <div className="flex justify-between">
                              <span>Extras:</span>
                              <span className="font-bold">
            ...
            <>
              <div className="text-center">
                ...
                <p className="mb-6" style={{ color: colors.darkBlue }}>
                  Your account has been created and your reservation is
  ...
  const ContractModal = () => {
    const handleCreateContract = (e) => {
      ...
      const newContract = {
        ...
        ...contractData,
        invoiceNumber: `INV-2024-${String(contracts.length + 1).padStart(
          3,
          "0"
        )}`,
        contractStatus: "Pending Signature",
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div
                ...
                onClick={() =>
                  setInvestmentData({ ...investmentData, location: "byron" })
                }
              >
                <h4
                  className="font-bold text-lg"
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {Object.entries(cabins).map(([key, cabin]) => (
                ...
                >
                  <h4 className="font-bold" style={{ color: colors.darkBlue }}>
                    {cabin.name}
                  </h4>
                  <p
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <span>Cabin Type:</span>
                  <span className="font-bold">
                    {cabins[selectedCabin].name}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Purchase Price:</span>
                  <span className="font-bold">
                    ${cabins[selectedCabin].price.toLocaleString()} plus GST
                  </span>
                </div>
                <div className="flex justify-between">
  ...
  const FloatingInvestmentPanel = () => {
    ...
    const calculateExtrasTotal = () => {
      ...
      return extras.reduce((total, extra) => {
        return (
          total +
          (floatingInvestmentData.selectedExtras.includes(extra.id)
            ? extra.price
            : 0)
        );
      }, 0);
              ...
              <div className="space-y-2">
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input
                    ...
                    name="location"
                    checked={
                      floatingInvestmentData.selectedLocation === "mansfield"
                    }
                    onChange={() =>
                      setFloatingInvestmentData({
                        ...floatingInvestmentData,
                ...
                <label className="flex items-center space-x-3 cursor-pointer">
                  <input
                    ...
                    name="location"
                    checked={
                      floatingInvestmentData.selectedLocation === "byron"
                    }
                    onChange={() =>
                      setFloatingInvestmentData({
                        ...floatingInvestmentData,
                        selectedLocation: "byron",
                      })
                    }
                    className="w-4 h-4"
                  />
                  ...
                  {[
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <input
                          type="checkbox"
                          checked={floatingInvestmentData.selectedExtras.includes(
                            extra.id
                          )}
                ...
                <div className="space-y-1 text-sm">
                  ...
                  {calculateExtrasTotal() > 0 && (
                    <div className="flex justify-between">
                      <span>Extras:</span>
                      <span className="font-bold">
                        ${calculateExtrasTotal().toLocaleString()}
                      </span>
                    </div>
                  )}
  ...
  const InvestmentModal = () => {
    ...
    const selectedCabin = selectedCabinForInvestment
      ? cabins[selectedCabinForInvestment]
      : null;
                  ...
                  >
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {extra.impactDescription || extra.description}
                        </p>
                        {(() => {
                          const extraROI = calculateExtraROI(
                            extra.id,
              ...
              <div className="space-y-4">
                ...
                {(() => {
                  ...
                  const expectedROI = calculateROI(
                    selectedCabinForInvestment,
                    66,
                    defaultNightlyRates[selectedCabinForInvestment],
                    selectedExtrasList
                  );
                  const baseROI = calculateROI(
                    selectedCabinForInvestment,
                  ...
                  const annualIncomeImprovement =
                    expectedROI.netIncome - baseROI.netIncome;
                      ...
                      <div className="text-center">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-3 text-sm">
                          <div className="bg-white p-2 rounded">
                            ...
                            >
                              $
                              {baseROI.netIncome.toLocaleString("en-AU", {
                                maximumFractionDigits: 0,
                              })}
                            </div>
                          </div>
                          <div className="bg-white p-2 rounded">
                            ...
                            >
                              $
                              {expectedROI.netIncome.toLocaleString("en-AU", {
                                maximumFractionDigits: 0,
                              })}
                            </div>
                          </div>
  ...
  const AttitudeChangeModal = () => {
    ...
    return (
      ...
      >
        ...
        >
          <h2
            className="text-2xl font-bold mb-4 italic"
            style={{
              fontFamily:
                '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
              fontWeight: "900",
          ...
          >
            <p className="text-sm" style={{ color: colors.darkBlue }}>
              <strong>Please note:</strong> Changing this decision is OK, but
              any payments will fall on the following month, not now.
            </p>
          </div>
          <div className="flex gap-4">
            <button
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto relative">
          ...
          <p className="text-sm mb-6" style={{ color: colors.darkBlue }}>
            {selectedInvestmentForBoost.cabinType} Cabin -{" "}
            {selectedInvestmentForBoost.location}
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {boostTiers.map((tier) => (
                ...
                >
                  ...
                  <h4
                    className="text-xl sm:text-2xl font-bold mb-2 italic"
                    style={{
                      fontFamily:
                        '"Eurostile Condensed", "Arial Black", Impact, sans-serif',
                      fontWeight: "900",
                  ...
                  <ul className="space-y-1 sm:space-y-2 text-xs sm:text-sm">
                    {tier.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start gap-2">
                        <span style={{ color: colors.aqua, flexShrink: 0 }}>
                          ✓
                        </span>
                        <span style={{ color: colors.darkBlue }}>
                          {feature}
          ...
          {selectedBoostTier && selectedPaymentMethod && (
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              <h4 className="font-bold mb-2" style={{ color: colors.darkBlue }}>
                Boost Summary
              </h4>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
